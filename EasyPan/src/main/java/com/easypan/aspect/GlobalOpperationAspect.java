...
@Aspect
@Component("globalOpperationAspect")
public class GlobalOpperationAspect {

    private static final Logger logger =  LoggerFactory.getLogger(GlobalOpperationAspect.class);
